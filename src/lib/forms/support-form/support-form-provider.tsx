...
import { supportFormUiReducerWithDisplay } from './support-form-ui-reducer';
...
export function SupportFormProvider({ children, mode }: PropsWithChildren & SupportFormProps) {
  ...
  const [uiState, updateUiState] = useReducer(supportFormUiReducerWithDisplay, {
    mode: mode,
    ...
    display: {
        supportFormBackButton: false,
        supportFormNavigateAway: false,
        supportFormProgress: false,
        selectPatient: false,
        guestStartSupportTicket: false,
        supportModal: false,
        insertLocationSelector: false,
        dateInputIssue: false,
        issueCategorySelectorWithTimeModal: false,
        supportSelectMyProduct: false,
        specifyProduct: false,
        tsgInterview: false,
        collectAuthUserInfo: false,
        collectGuestUserInfo: false,
        supportSubmitModal: false
    },
    progress: 0,
    flags: {
